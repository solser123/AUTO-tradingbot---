...
class BotConfig:
    ...
    def from_env(cls) -> "BotConfig":
        ...
        config = cls(
            ...
            short_stoch_min=_as_float("BOT_SHORT_STOCH_MIN", 45.0),
            short_stoch_max=_as_float("BOT_SHORT_STOCH_MAX", 85.0),
            long_stoch_min=_as_float("BOT_LONG_STOCH_MIN", 15.0),
            long_stoch_max=_as_float("BOT_LONG_STOCH_MAX", 55.0),
            require_signal_candle_confirmation=_as_bool(os.getenv("BOT_REQUIRE_SIGNAL_CANDLE_CONFIRMATION"), True),
